...
export default class Images {
    ...
    static etcLogo = require("./etcLogo.png");
    static etlLogo = require("./etlLogo.png");
    ...
    static downloadAsync(): Promise<*>[] {
        return [
            ...
            Asset.fromModule(Images.etcLogo).downloadAsync(),
            Asset.fromModule(Images.etlLogo).downloadAsync(),
